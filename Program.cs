...
//int[] CreateRandomArray(int min, int max) // иногда пишут (int N, int start (у меня мин) , int end (у меня макс) - (количество элементов (размерность массива), min и max - минимум и максимум диапазона чисел)
//{
